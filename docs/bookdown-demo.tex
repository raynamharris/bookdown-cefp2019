...
\hypertarget{rational-for-community-managers}{%
\section{Rational for community managers}\label{rational-for-community-managers}}

\hypertarget{quick-start}{%
\section{Quick start}\label{quick-start}}

You can label chapter and section titles using \texttt{\{\#label\}} after them, e.g., we can reference Chapter \ref{who}. If you do not manually label them, there will be automatic labels anyway, e.g., Chapter \ref{program}.
